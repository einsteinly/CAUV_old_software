...
# Generated for 8ec0addfbaf2c0c73c5ad696a0cac9d6dde5ec13
...
p_UID = pp.Forward()
p_BoundedFloatBase = pp.Forward()
p_ImageRegion = pp.Forward()
p_Range = pp.Forward()
p_DynamicEnum = pp.Forward()
...
p_SensorUIDBase = pp.Forward()
p_BoundedFloatType = pp.Forward()
p_ParamValueType = pp.Forward()
...
p_Ellipse << pp.Group(l \
    + p_floatXY + c \
    + p_float + c \
    + p_float + c \
    + p_float \
    + r)
p_Ellipse.setParseAction(lambda x: messaging.Ellipse(*x[0]))
p_Corner << pp.Group(l \
    + p_floatXYZ + c \
    + p_float + c \
    + p_float + c \
...
p_UID << pp.Group(l \
    ...
    + p_int \
    + r)
p_UID.setParseAction(lambda x: messaging.UID(*x[0]))
p_BoundedFloatBase << pp.Group(l \
    + p_float + c \
    + p_float + c \
    + p_float + c \
    + p_BoundedFloatType \
    + r)
p_BoundedFloatBase.setParseAction(lambda x: messaging.BoundedFloatBase(*x[0]))
p_ImageRegion << pp.Group(l \
    + p_floatXY + c \
    + p_floatXY \
    + r)
p_ImageRegion.setParseAction(lambda x: messaging.ImageRegion(*x[0]))
p_Range << pp.Group(l \
    + p_float + c \
    + p_float \
    + r)
p_Range.setParseAction(lambda x: messaging.Range(*x[0]))
p_DynamicEnum << pp.Group(l \
    + p_str + c \
    + p_stringVec \
    + r)
p_DynamicEnum.setParseAction(lambda x: messaging.DynamicEnum(*x[0]))
...
p_ParamValue_9 = l + pp.Literal('9') + c + p_BoundedFloat  + r
p_ParamValue_9.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_10 = l + pp.Literal('10') + c + p_int32Vec  + r
p_ParamValue_10.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_11 = l + pp.Literal('11') + c + p_ImageRegion  + r
p_ParamValue_11.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_12 = l + pp.Literal('12') + c + p_Range  + r
p_ParamValue_12.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_13 = l + pp.Literal('13') + c + p_floatXY  + r
p_ParamValue_13.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_14 = l + pp.Literal('14') + c + p_DynamicEnum  + r
p_ParamValue_14.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_15 = l + pp.Literal('15') + c + p_floatXYVec  + r
p_ParamValue_15.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue_16 = l + pp.Literal('16') + c + p_EllipseVec  + r
p_ParamValue_16.setParseAction(lambda x: messaging.ParamValue.create(x[1]))
p_ParamValue << (
    p_ParamValue_0 ^
    p_ParamValue_1 ^
    p_ParamValue_2 ^
...
p_EllipseVec << pp.Group(l + pp.Optional(pp.delimitedList(p_Ellipse)) + r)
p_EllipseVec.setParseAction(a__vec_gen(messaging.EllipseVec))
...
p_floatXYVec << pp.Group(l + pp.Optional(pp.delimitedList(p_floatXY)) + r)
p_floatXYVec.setParseAction(a__vec_gen(messaging.floatXYVec))
...
p_SensorUIDBase << p_int
p_SensorUIDBase.setParseAction(lambda x: messaging.SensorUIDBase(x[0]))
p_BoundedFloatType << p_int
p_BoundedFloatType.setParseAction(lambda x: messaging.BoundedFloatType(x[0]))
p_ParamValueType << p_int
p_ParamValueType.setParseAction(lambda x: messaging.ParamValueType(x[0]))
...
p_EllipsesMessage = pp.Group(l \
    + p_str + c \
    + p_EllipseVec \
    + r).streamline()
p_EllipsesMessage.setParseAction(lambda x: messaging.EllipsesMessage(*x[0]))
...
p_PointsMessage = pp.Group(l \
    + p_str + c \
    + p_floatXYVec \
    + r).streamline()
p_PointsMessage.setParseAction(lambda x: messaging.PointsMessage(*x[0]))
...
def parseMessage(s):
    ...
    if msgid == 500:
        ...
        return p_RequestAIStateMessage.parseString(s[msgstart:])[0]
    elif msgid == 216:
