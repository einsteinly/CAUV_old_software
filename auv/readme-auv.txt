...
In rough order of importance and relevance:
...
sonar/       - Program to forward data from the SeaSprite scanning sonar.
...
lib/         - various 3rd-party libraries (xsens stuff, GeminiSDK)
