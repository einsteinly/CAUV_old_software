...
class MessageTest(unittest.TestCase):
  ...
  def test_self_discard(self):
    self.assert_(not self.message.is_self_discard())
    self.message.set_self_discard()
    self.assert_(self.message.is_self_discard())
  ...
  def test_service(self):
    ...
    self.assert_(self.message.is_self_discard())
    self.assert_(self.message.is_reliable())
    self.assert_(not self.message.is_fifo())
  ...
  def test_read(self):
    ...
    # Probably shouldn't use readn in Python because strings are immutable!
    foo = "   "
