 ...
 * to the data via:
 * <pre>&message[0]</pre>
 * You can do this because detail::Buffer is derived from std::vector and we
 * guarantee this behavior is defined even though we do not consider
 * detail::Buffer to be part of the public API.
