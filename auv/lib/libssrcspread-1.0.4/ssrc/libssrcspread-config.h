...
#define LIBSSRCSPREAD_HAVE_NAMESPACES   
#endif

/* Spread toolkit is available. */
#ifndef LIBSSRCSPREAD_HAVE_SPREAD 
#define LIBSSRCSPREAD_HAVE_SPREAD  1 
#endif

/* Spread version 3.x is available. */
/* #undef LIBSSRCSPREAD_HAVE_SPREAD3 */

/* Spread version 4.x is available. */
#ifndef LIBSSRCSPREAD_HAVE_SPREAD4 
#define LIBSSRCSPREAD_HAVE_SPREAD4  1 
#endif

/* Define to 1 if you have the `SP_get_memb_info' function. */
#ifndef LIBSSRCSPREAD_HAVE_SP_GET_MEMB_INFO 
#define LIBSSRCSPREAD_HAVE_SP_GET_MEMB_INFO  1 
#endif

/* Define to 1 if you have the `SP_kill' function. */
#ifndef LIBSSRCSPREAD_HAVE_SP_KILL 
#define LIBSSRCSPREAD_HAVE_SP_KILL  1 
#endif
...
#define LIBSSRCSPREAD_PACKAGE_STRING  "libssrcspread 1.0.4" 
#endif
...
#define LIBSSRCSPREAD_PACKAGE_VERSION  "1.0.4" 
#endif
...
#define LIBSSRCSPREAD_VERSION  "1.0.4" 
#endif
