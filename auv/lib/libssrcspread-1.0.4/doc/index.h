...
Ssrc C++/Lua/Perl/Python/Ruby Bindings for %Spread is Copyright 2006-2009 by
...
At the moment, Ssrc C++/Lua/Perl/Python/Ruby Bindings for %Spread depends on
the GNU development tool chain (g++, gmake, autoconf, automake, and
libtool).  To compile on Win32 platforms you will need a GNU
development environment such as Cygwin or MinGW.  The software has been
tested on Linux (2.6.x series kernel), FreeBSD 7.1, and Solaris 10.

The unit tests require CppUnit (cppunit.sourceforge.net) to compile
...
<code>PYTHONPATH</code>, and <code>RUBYLIB</code>, and environment variables.
...
Finally, these bindings have been tested and verified with SWIG 1.3.34,
Lua 5.1.3, Perl 5.8.8, Python 2.5, and Ruby 1.8.6, but may work with other
versions.
...
<pre>
mbox = ssrc.spread.Mailbox("4803@localhost", "", True, ssrc.spread.Timeout(3));</pre>
or:
<pre>
mbox = ssrc.spread.Mailbox("4803@localhost", "", True, 3);</pre>
